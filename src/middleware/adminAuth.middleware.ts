...
export const adminLoginMiddleware = async (req: CustomRequest, res: Response, next: NextFunction) => {
    ...
    try {
        const decodedToken = jwt.verify(token, process.env.JWT_SECRET_ADMIN || '') as DecodedUser; 
